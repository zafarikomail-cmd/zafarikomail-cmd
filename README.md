...
| [🎤 Vocal Academy](https://github.com/zafarikomail-cmd/Vocal-Academy) | PWA helping Afghan women learn English from zero to TOEFL | HTML, CSS | [▶ Live](https://vocalacademy.pages.dev/) |
| [🧠 NUTECH Vault](https://github.com/zafarikomail-cmd/nutech-vault) | Personal memory & notes platform for NUTECH students | JavaScript | [▶ Live](https://nutech-vault.pages.dev/) |
...
- 🔧 Improving existing projects with new features
