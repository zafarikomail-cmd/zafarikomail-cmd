...
- 🎓 2nd Semester BS IT Student at **NUTECH University, Islamabad**
- 💼 Check out my **[Personal Portfolio](https://zafarikomail-cmd.github.io)** to see my work
- 🔨 I build real web apps using **HTML, CSS, JavaScript & Node.js**
- 🌱 Currently learning **React, Backend Development & Full-Stack Architecture**
- 🚀 All my projects are **live and deployed** — check them below!
- 🇦🇫 From Afghanistan, studying in Pakistan — building things that matter
...
- 📚 Deepening my knowledge of **React.js & modern frontend frameworks**
- 🔧 Improving existing projects with new features and better UX
- 💡 Building new tools that solve real problems for students
...
**Student Projects:**
- [Grade-Flow](https://github.com/zafarikomail-cmd/Grade-FLow) - Semester tracker for students
- [NUTECH Vault](https://github.com/zafarikomail-cmd/nutech-vault) - Notes & information management
